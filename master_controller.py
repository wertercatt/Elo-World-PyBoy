...
from battle_x_as_y import battle_x_as_y, get_trainer_by_id, json, trainers, uuid
...
trainer_list = [
    ...
    for trainer_instance in trainer_class["instances"]
]

with open("battles_to_run_rival.json") as f:
...
def run(index):
    ...
    battle_x_as_y(
        ...
        enemy_class,
        enemy_instance,
        run_number=("rival_hotfix/" + str(uuid.uuid4())),
        save_movie=False,
    )
