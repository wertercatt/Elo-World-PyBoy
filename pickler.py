...
from common_types import Action, Battle, Pokemon, Trainer, Turn
...
def main():
    ...
    with open("omega2_redux.json") as f:
    ...
    for battle in progressbar.progressbar(json_battles):
        ...
        trainer = trainer_dict.setdefault(
            ...
            Trainer(
                ...
                trainer_instance,
                [
                    Pokemon(mon["species"], mon["max_hp"])
                    for mon in battle["trainer_party_mons"]
                ],
            ),
        )
        ...
        enemy = trainer_dict.setdefault(
            ...
            Trainer(
                ...
                [
                    Pokemon(mon["species"], mon["max_hp"])
                    for mon in battle["enemy_party_mons"]
                ],
            ),
        )
